...
TEST(HasMatchingFileExtension, Exists) {
  EXPECT_DURATION_LE(
      MAX_DURATION_MS, EXPECT_EQ(true, HasMatchingFileExtension("image.jpg", ".jpg")));
  EXPECT_DURATION_LE(
      MAX_DURATION_MS, EXPECT_EQ(true, HasMatchingFileExtension("image.png", ".png")));
  EXPECT_DURATION_LE(
      MAX_DURATION_MS, EXPECT_EQ(true, HasMatchingFileExtension("image.JPEG", ".JPEG")));
  EXPECT_DURATION_LE(
      MAX_DURATION_MS, EXPECT_EQ(true, HasMatchingFileExtension("image.GIF", ".GIF")));
}

TEST(HasMatchingFileExtension, NotExist) {
  EXPECT_DURATION_LE(
      MAX_DURATION_MS, EXPECT_EQ(false, HasMatchingFileExtension("image.jpg", ".foo")));
  EXPECT_DURATION_LE(
      MAX_DURATION_MS, EXPECT_EQ(false, HasMatchingFileExtension("image.png", ".foo")));
  EXPECT_DURATION_LE(MAX_DURATION_MS,
                     EXPECT_EQ(false, HasMatchingFileExtension(".fo", ".foo")));
  EXPECT_DURATION_LE(
      MAX_DURATION_MS, EXPECT_EQ(false, HasMatchingFileExtension("image.FOO", ".foo")));
}
