...
targets = ['animated_gradient', 'make_message']

lab = {
    # Due date for labs
    'mon_duedate': date(2023, 12, 13),
    'tues_duedate': date(2023, 12, 6),
    'wed_duedate': date(2023, 12, 6),
...
global_tidy_checks = (
    ...
    # warns about static objects in lab12 part-2/make_message_functions.cc
...
global_makefile = {
    'CXX': 'clang++',
    'CXXFLAGS': '-g -O3 -Wall -pedantic -pipe -std=c++17 -I/usr/include/GraphicsMagick',
    'LDFLAGS': '-g -O3 -Wall -pedantic -pipe -std=c++17 -lGraphicsMagick -lGraphicsMagick++',
